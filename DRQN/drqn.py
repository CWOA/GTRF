...
For more reinforcment learning tutorials, as well as the additional required gridworld.py and helper.py see: https://github.com/awjuliani/DeepRL-Agents
"""
...
Making it smaller (adjusting size) provides an easier task for our DRQN agent, while making the world larger increases the challenge.
...
Below are examples of a starting environment in our simple game. 
